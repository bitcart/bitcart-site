<template>
  <div>
    <h2 style="text-align: center">
      <b>BITCART PAID PLUGINS TERMS OF SERVICE</b>
    </h2>
    <p>Last updated: 2025-03-05</p>
    <p>1. <b>Introduction</b></p>
    <p>Welcome to <b>Bitcart</b> ("Company", "we", "our", "us")!</p>
    <p>
      These Terms of Service ("Terms", "Terms of Service") govern your use of
      our paid plugins available through the license server at
      <b>licensing.bitcart.ai</b> and accessible via the plugins page of your
      Bitcart instance (together or individually "Service") operated by
      <b>Bitcart</b>.
    </p>
    <p>
      These Terms specifically apply to the paid plugins and extensions
      available for purchase and use with your Bitcart instance. The plugins are
      distributed through our license server at licensing.bitcart.ai and can be
      installed and managed through your Bitcart instance's plugins page.
    </p>
    <p>
      IMPORTANT: Bitcart plugins operate on your own self-hosted Bitcart
      instance. You maintain full control and responsibility for all
      cryptocurrency assets and funds processed through your instance. We do not
      have access to, control over, or responsibility for any cryptocurrency or
      other assets managed by your Bitcart instance or any plugins installed on
      it.
    </p>
    ...
    <p>
      ...
      <a href="mailto:support@bitcart.ai"><b>support@bitcart.ai</b></a
      >.
    </p>
    <p>3. <b>Purchases</b></p>
    <p>
      ...
      your Purchase including but not limited to, your credit or debit card
      number, the expiration date of your card, your billing address, and other
      payment information.
    </p>
    <p>
    ...
    <p>5. <b>Refunds</b></p>
    <p>
      We issue refunds for Paid Plugin purchases within <b>30 days</b> of the
      original purchase date. Refund requests must be submitted to
      <a href="mailto:support@bitcart.ai"><b>support@bitcart.ai</b></a> with
      your purchase details and reason for the refund request.
    </p>
    <p>6. <b>Content</b></p>
    <p>
    ...
    <p>
      Bitcart has the right but not the obligation to monitor and edit all
      Content provided by users.
    </p>
    <p>
      In addition, Content found on or through this Service are the property of
      Bitcart or used with permission. You may not distribute, modify, transmit,
    ...
    <p>
      ...
      Bitcart and its licensors. Service is protected by copyright, trademark,
    ...
    <p>
      12. <b>DMCA Notice and Procedure for Copyright Infringement Claims</b>
    </p>
    <p>
    ...
    <p>
      ...
      <a href="mailto:support@bitcart.ai"><b>support@bitcart.ai</b></a> or via
    ...
    <p>
      ...
      are not owned or controlled by Bitcart.
    </p>
    <p>
      Bitcart has no control over, and assumes no responsibility for the
    ...
    <p>15. <b>Disclaimer Of Warranty and Cryptocurrency Assets</b></p>
    <p>
    ...
    <p>
      CRYPTOCURRENCY DISCLAIMER: YOU EXPRESSLY UNDERSTAND AND AGREE THAT BITCART
      AND ITS PAID PLUGINS OPERATE ON YOUR SELF-HOSTED INSTANCE. WE HAVE NO
      ACCESS TO OR CONTROL OVER ANY CRYPTOCURRENCY, FUNDS, OR OTHER ASSETS
      PROCESSED THROUGH YOUR INSTANCE. YOU ARE SOLELY RESPONSIBLE FOR THE
      SECURITY, BACKUP, AND MANAGEMENT OF ALL PRIVATE KEYS, FUNDS, AND ASSETS.
      IN NO EVENT SHALL WE BE LIABLE FOR ANY LOSS OF CRYPTOCURRENCY OR OTHER
      ASSETS, WHETHER DUE TO PLUGIN FUNCTIONALITY, SECURITY ISSUES, OR ANY OTHER
      CAUSE.
    </p>
    <p>
    ...
    <p>
      ...
      email: <a href="mailto:support@bitcart.ai"><b>support@bitcart.ai</b></a
      >.
    </p>
  </div>
</template>
