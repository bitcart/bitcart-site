<template>
  <div>
    <h2 style="text-align: center">
      <b>BITCART PAID PLUGINS PRIVACY POLICY</b>
    </h2>

    <p>Effective date: 2025-03-05</p>

    <p>1. <b>Introduction</b></p>

    <p>Welcome to <b>Bitcart Paid Plugins</b>.</p>

    <p>
      <b>Bitcart</b> ("us", "we", or "our") operates the paid plugins licensing
      system at <b>licensing.bitcart.ai</b> and the plugins functionality
      accessible via your Bitcart instance's plugins page (hereinafter referred
      to as <b>"Service"</b>).
    </p>

    <p>
      Our Privacy Policy governs your use of paid plugins available at
      <b>licensing.bitcart.ai</b> and through your Bitcart instance's plugins
      page, and explains how we collect, safeguard and disclose information that
      results from your use of our Service.
    </p>

    <p>
      We use your data to provide and improve the Service, specifically for
      licensing and functionality of paid plugins. By using the Service, you
    ...
    <p>
      <b>SERVICE</b> means the licensing.bitcart.ai website and paid plugins
      functionality operated by Bitcart.
    </p>
    ...
    <p>
      ...
      identify you (<b>"Personal Data"</b>) for the purposes of plugin licensing
      and support. Personally identifiable information may include, but is not
      limited to:
    </p>
    ...
    <p>0.3. License key information</p>

    <p>0.4. Server instance identifier</p>
    ...
    <p>
      ...
      professional training, employment agreements,information on bonuses and
      compensation, information on marital status, family members, social
      security (or other taxpayer identification) number, office location and
      other data.
    </p>
    ...
    <p>
      Bitcart uses the collected data for various purposes related to paid
      plugins:
    </p>

    <p>0.1. to provide and maintain our plugin licensing Service;</p>

    <p>0.2. to notify you about changes to our Service and plugins;</p>

    <p>0.3. to verify plugin licenses and ensure proper functionality;</p>

    <p>0.4. to provide plugin support;</p>
    ...
    <p>0.6. to monitor the usage of our plugins;</p>
    ...
    <p>
      ...
      plugin licenses entered into between you and us, including for billing and
      collection;
    </p>

    <p>
      0.10. to provide you with notices about your plugin licenses and/or
    ...
    <p>
      Bitcart will take all the steps reasonably necessary to ensure that your
    ...
    <p>
      ...
      along with the category of any other company we sold it to. If we have not
